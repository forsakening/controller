...
void AgentParam::ParseHypervisorArguments
    ...
    if (var_map.count("HYPERVISOR.type") &&
        ...
        if (var_map["HYPERVISOR.type"].as<string>() == "xen") {
            ...
            GetOptValue<string>(var_map, vmware_physical_interface_pci_addr_,
                                "HYPERVISOR.vmware_physical_interface_pci_addr");
            GetOptValue<string>(var_map, vmware_physical_interface_mac_addr_,
                                "HYPERVISOR.vmware_physical_interface_mac_addr");
        } else {
...
void AgentParam::LogConfig() const {
    ...
    LOG(DEBUG, "Vmware port pci             : " << vmware_physical_interface_pci_addr_);
    LOG(DEBUG, "Vmware port mac             : " << vmware_physical_interface_mac_addr_);
...
AgentParam::AgentParam(bool enable_flow_options,
        ...
        vmware_physical_interface_pci_addr_(""),
        vmware_physical_interface_mac_addr_(""),
