...
public:
    ...
    std::string vmware_physical_interface_pci_addr() const {
        return vmware_physical_interface_pci_addr_;
    }
    std::string vmware_physical_interface_mac_addr() const {
        return vmware_physical_interface_mac_addr_;
    }
...
private:
    ...
    std::string vmware_physical_interface_pci_addr_;
    std::string vmware_physical_interface_mac_addr_;
    bool test_mode_;
