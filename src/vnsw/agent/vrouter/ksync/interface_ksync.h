...
private:
    ...
    int32_t inbound_cir_;
    int32_t inbound_pir_;
    int32_t inbount_cbs_;
    int32_t inbount_ebs_;
    int32_t inbount_pbs_;
    int32_t outbound_cir_;
    int32_t outbound_pir_;
    int32_t outbount_cbs_;
    int32_t outbount_ebs_;
    int32_t outbount_pbs_;
    bool persistent_;
