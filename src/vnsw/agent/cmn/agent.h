...
class QosBwEntry;
typedef boost::intrusive_ptr<QosBwEntry> QosBwEntryRef;
typedef boost::intrusive_ptr<const QosBwEntry> QosBwEntryConstRef;
void intrusive_ptr_release(const QosBwEntry* p);
void intrusive_ptr_add_ref(const QosBwEntry* p);
...
public:
    ...
    QosBwTable *qos_bw_table() const { return qos_bw_table_;};
    void set_qos_bw_table(QosBwTable *table) {
        qos_bw_table_ = table;
    }
