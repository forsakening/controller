...
VizCollector::VizCollector(EventManager *evm, string listen_server, unsigned short listen_port,
    ...
    collector_(new Collector(evm, listen_server, listen_port, sandesh_config,
