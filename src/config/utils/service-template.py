...
class ServiceTemplateCmd(object):
    ...
    def __init__(self, args_str=None):
        ...
        if self._args.svc_type in ['analyzer', 'source-nat']:
            ...
            self._if_list = [['management', False], [
                'left', self._args.svc_scaling], ['right', self._args.svc_scaling]]
    ...
    def _parse_args(self, args_str):
        ...
        create_parser.add_argument(
            "--svc_scaling", action="store_true", default=True,
            help="enable service scaling [default: True]")
        create_parser.add_argument(
            "--svc_virt_type", default='virtual-machine',
            help="define virtualization type [default: virtual-machine]")
        create_parser.add_argument(
            "--svc_mode", default=None,
            help="define service mode [default: None]")
    ...
    def create_st(self):
        ...
        if self._args.svc_mode:
            svc_properties.set_service_mode(self._args.svc_mode)
