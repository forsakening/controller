...
class LoadbalancerAgent(Agent):
    ...
    def __init__(self, svc_mon, vnc_lib, object_db, config_section):
        ...
        self._create_default_service_appliance_set(
            "hillstone",
            "svc_monitor.services.loadbalancer.drivers.hillstone.driver.HillstoneDriver"
        )
        self._create_default_service_appliance_set(
            "certus",
            "svc_monitor.services.loadbalancer.drivers.certus.driver.CertusDriver"
        )
        self._create_default_service_appliance_set(
            "flexlb",
            "svc_monitor.services.loadbalancer.drivers.flexlb.driver.FlexLbDriver"
        )
